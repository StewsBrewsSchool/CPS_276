...
class DatabaseConn {	
  ...
  public function dbOpen(){
    ...
    try {
      ...
      $dbHost = 'localhost';
      $dbName = 'stweber';//this will be your WCC username
      $dbUsr = 'stweber';//this will be your WCC username
      $dbPass = 'eDrZ53xJxXEv';//this will be the password found in the video.
